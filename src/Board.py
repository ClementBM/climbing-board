...
class Board:
  ...
  def __init__(self,
    ...
    hold_list = [alpha + str(digit) for digit in range(1,vertical_count+1) for alpha in self.alpha_indices]
  ...
  def _opposite_hold(self, hold: str) -> str:
    ...
    if self.horizontal_count % 2 != 0 and letter_index == ((self.horizontal_count - 1) / 2):
      return hold
